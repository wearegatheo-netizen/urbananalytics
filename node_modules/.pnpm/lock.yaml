  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.4.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.4.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.4.tgz':
    resolution: {integrity: sha512-x6NCWv+5aPnrsuZG6vbZucTzDrCQt+C4Qf34GG/sSQvsALZt81Y8D/TqIwmS4XOCzSZZVKVKsB3tYhVJapIQrQ==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.4.tgz}
    version: 2.8.4
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
